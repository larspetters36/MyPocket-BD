        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body text-center">
                ...
                <h1 class="fw-bold text-primary">
                    R$ <?= number_format($carteira->fimMesSaldo(), 2, ',', '.') ?>
                </h1>
            </div>
        </div>

        <div class="text-end mb-4">
        <a href="previsao.php" class="btn btn-outline-primary btn-sm">Ver previsão do ano inteiro</a>
    </div>
                        ...
                        <form method="POST" action="processa.php">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipo" id="receita"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipo" id="despesa" value="saida">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="valor" class="form-control" placeholder="R$ 0,00">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Descrição</label>
                                <input type="text" name="descricao" class="form-control" placeholder="Ex: Mercado">
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-bold">A transação é recorrente?</label>
                                <select name="eh_recorrente" id="eh_recorrente" class="form-select"
